...
// Test Mail Route - Test với nhiều cấu hình
Route::get('/test-mail', function () {
    try {
        ...
        return response()->json([
            ...
            'suggestions' => getMailSuggestions($results),
...
// Helper function để đưa ra gợi ý
if (!function_exists('getMailSuggestions')) {
    function getMailSuggestions($results) {
        $suggestions = [];
...
// Test Mail Route Đơn Giản (nếu route /test-mail bị lỗi)
