...
function ajax_get_prices_tour(id_tour,date,id_type) {
    $.ajax({
        url: '/index.php?module=home&view=home&task=ajax_get_prices_tour&raw=1&id='+id_tour+'&date='+date+'&type='+id_type,
        type : 'post',
        dataType: 'json',  
        success : function(data){
            ...
            for (i = 0; i < data.length; i++){            
                ...
                if(item['is_select'] == 1 && item['is_disable'] != 1 && item['is_limit'] != 1){
                    var select = 'selected';
...
function ajax_count_prices_tour(id_type) {
    $.ajax({
        url: '/index.php?module=home&view=home&task=ajax_count_prices_tour&raw=1&id='+id_type,
        type : 'post',
        dataType: 'json',  
        success : function(data){
            $("#price_tour").html("");
