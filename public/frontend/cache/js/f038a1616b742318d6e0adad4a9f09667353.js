...
$(window).load(function(){
	 $("#sync1 .grid-item").removeClass('hide');
	var sync1 = $("#sync1");
	var flag = false;
    var duration = 300;
	...
	sync1.owlCarousel({
		...
		nav : false,
		navText : [
		'<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M30 0C13.4306 0 0 13.4306 0 30C0 46.5675 13.4306 60 30 60C46.5694 60 60 46.5675 60 30C60 13.4306 46.5694 0 30 0ZM43.125 31.875H23.2763L31.003 39.6019C31.7363 40.335 31.7363 41.5219 31.003 42.253C30.2699 42.9863 29.0831 42.9863 28.3519 42.253L17.745 31.6463C17.2969 31.1981 17.1563 30.5813 17.2593 30C17.1562 29.4187 17.2969 28.8019 17.7469 28.3519L28.3537 17.745C29.0869 17.0119 30.2737 17.0119 31.005 17.745C31.7381 18.4781 31.7381 19.665 31.005 20.3963L23.2763 28.125H43.125C44.16 28.125 45 28.965 45 30C45 31.035 44.16 31.875 43.125 31.875Z" fill="white"/> </svg>',
		'<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M30 60C46.5694 60 60 46.5694 60 30C60 13.4325 46.5694 -1.17414e-06 30 -2.62268e-06C13.4306 -4.07123e-06 4.07106e-06 13.4325 2.62268e-06 30C1.17414e-06 46.5694 13.4306 60 30 60ZM16.875 28.125L36.7237 28.125L28.997 20.3981C28.2637 19.665 28.2637 18.4781 28.997 17.747C29.7301 17.0137 30.9169 17.0137 31.6481 17.747L42.255 28.3537C42.7031 28.8019 42.8437 29.4187 42.7407 30C42.8438 30.5813 42.7031 31.1981 42.2531 31.6481L31.6463 42.255C30.9131 42.9881 29.7263 42.9881 28.995 42.255C28.2619 41.5219 28.2619 40.335 28.995 39.6037L36.7237 31.875L16.875 31.875C15.84 31.875 15 31.035 15 30C15 28.965 15.84 28.125 16.875 28.125Z" fill="white"/> </svg>'
		],
		autoplay:true,
