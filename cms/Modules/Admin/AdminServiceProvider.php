...
use Cms\Modules\Admin\Repositories\BusRepository;
...
use Cms\Modules\Admin\Services\BusService;
...
use Cms\Modules\Admin\Services\TourDetailService;
use Cms\Modules\Admin\Repositories\TourDetailRepository;
...
class AdminServiceProvider extends CmsServiceProvider{
    ...
    public function register()
    {
        ...
        $this->app->bind(BusServiceContract::class, BusService::class);
        $this->app->bind(SettingRepositoryContract::class, SettingRepository::class);
        $this->app->bind(BusRepositoryContract::class, BusRepository::class);
        ...
        $this->app->bind(TourDetailRepositoryContract::class, TourDetailRepository::class);
