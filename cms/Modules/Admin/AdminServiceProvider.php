...
use Cms\Modules\Admin\Repositories\TicketImageRepository;
use Cms\Modules\Admin\Repositories\TicketRepository;
...
use Cms\Modules\Admin\Services\TicketImageService;
use Cms\Modules\Admin\Services\TicketService;
...
class AdminServiceProvider extends CmsServiceProvider{
    ...
    public function register()
    {
        ...
        $this->app->bind(CarImageRepositoryContract::class, CarImageRepository::class);
        $this->app->bind(CarServiceContract::class, CarService::class);
        $this->app->bind(CarImageServiceContract::class, CarImageService::class);
        $this->app->bind(TicketImageRepositoryContract::class, TicketImageRepository::class);
