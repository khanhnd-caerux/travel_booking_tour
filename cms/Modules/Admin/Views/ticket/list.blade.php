@extends('Core::layouts.backend.app', ['activePage' => __('ticket') , 'titlePage' => __('Danh sách Vé xe du lịch')])
@section('js')
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div
                        ...
                        <h6 class="text-white text-capitalize ps-3">Danh sách Vé xe du lịch</h6>
                        <a class="btn bg-gradient-dark mb-0 mx-2" href="{{ route('admin.ticket.create') }}"><i
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr style="text-align: left">
                                    ...
                                    <td>{{ $ticket->price }}</td>
                                    <td>{{ $ticket->discount_percent }} %</td>
                                    <td>{{ $ticket->road }}</td>
                                    <td>{{ $ticket->updated_at }}</td>
                                    <td class="td-actions text-right">
                                        <a class="btn text-danger text-gradient px-3 mb-0 action_delete" href=""
                                            data-url="{{ route('admin.ticket.delete', ['id' => $ticket->id]) }}"><i
                                                class="material-icons text-sm me-2 ">delete</i>Delete</a>
                                        <a class="btn btn-link text-dark px-3 mb-0"
                                            href="{{ route('admin.ticket.edit', ['id' => $ticket->id]) }}"><i
