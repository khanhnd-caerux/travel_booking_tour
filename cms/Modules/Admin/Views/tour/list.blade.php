    ...
    function deleteMultiple() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                let form = $('<form>', {
                    'method': 'POST',
                    'action': '{{ route("admin.tour.deleteMultiple") }}'
                });
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div
                        ...
                        <h6 class="text-white text-capitalize ps-3 mb-0">Danh sách Tour du lịch</h6>
                        <div class="d-flex px-3">
                            ...
                            <a class="btn btn-sm btn-light mb-0" href="{{ route('admin.tour.create') }}">
