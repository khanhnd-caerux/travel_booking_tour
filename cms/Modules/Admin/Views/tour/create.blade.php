                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <div class="input-group input-group-outline my-3">
                                                <label class="form-label">Tour bao gồm</label>
                                                <input type="text" name="tour_includes" value="{{ old('tour_includes') }}"
                                        ...
                                        <div class="col-8">
                                            <div class="input-group input-group-outline my-3">
                                                <label class="form-label">Tour không bao gồm</label>
                                                <input type="text" name="tour_excludes" value="{{ old('tour_excludes') }}"
