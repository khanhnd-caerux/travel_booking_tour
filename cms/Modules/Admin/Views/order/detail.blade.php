    ...
    <div class="container-fluid py-4">
                                        ...
                                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="mb-2 text-xs">SDT: <span
                                                        class="text-dark font-weight-bold ms-sm-2">{{ $order->whats_app
                                                            }}</span></span>
        ...
        $order->note }}</span></span>
                                            ...
                                            <form action="{{ route('admin.order.update', ['id' => $order->id]) }}"
                                                ...
                                                <div class="ms-auto text-end">
                                                    <button class="btn btn-link text-dark px-3 mb-0" href="">
                                                        <i class="material-icons text-sm me-2">edit</i>Hoàn tất xác nhận
                                                        thông tin
                                                    </button>
                                                </div>
                                            </form>
                                ...
                                <div class="card-body p-3 col-8">
                                    ...
                                    <p>Ngày đi: {{ $order->orderDetail[0]->date_selected }}</p>
                                    {!! json_decode($order->orderDetail[0]->html_data) !!}
                                </div>
                            </div>
                        </div>
                    </div>
