...
<script>
    ...
    function deleteMultiple() {
        ...
        if (selectedIds.length === 0) {
            Swal.fire('Opps', 'Vui lòng chọn ít nhất 1 bài viết để xoá', 'warning');
            return;
        }
        ...
        Swal.fire({
            ...
            if (result.value) {
                let form = $('<form>', {
                    'method': 'POST',
                    'action': '{{ route("admin.post.deleteMultiple") }}'
                });
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div
                        ...
                        <h6 class="text-white text-capitalize ps-3 mb-0">Danh sách bài viết</h6>
                        <div class="d-flex px-3">
                            ...
                            <a class="btn btn-sm btn-light mb-0" href="{{ route('admin.post.create') }}">
                            ...
                            <tbody>
                                ...
                                <tr style="text-align: left">
                                    <td class="text-center">
                                        <div class="form-check p-0 m-0">
                                            <input class="form-check-input row-checkbox" type="checkbox" value="{{ $post->id }}" style="border: 1px solid #ced4da;">
                                        </div>
                                    </td>
