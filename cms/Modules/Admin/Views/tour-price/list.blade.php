@extends('Core::layouts.backend.app', ['activePage' => __('tour-price') , 'titlePage' => __('Danh sách giá Tour')])
@section('js')
    ...
    function deleteMultiple() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                let form = $('<form>', {
                    'method': 'POST',
                    'action': '{{ route("admin.tour_price.deleteMultiple") }}'
                });
    ...
    <div class="row">
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div
                        ...
                        <h6 class="text-white text-capitalize ps-3 mb-0">Danh sách giá Tour du lịch</h6>
                        <div class="d-flex px-3">
                            ...
                            <a class="btn btn-sm btn-light mb-0" href="{{ route('admin.tour_price.create') }}">
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($tourPrices as $tour)
                                <tr style="text-align: left">
                                    <td class="text-center">
                                        <div class="form-check p-0 m-0">
                                            <input class="form-check-input row-checkbox" type="checkbox" value="{{ $tour->id }}" style="border: 1px solid #ced4da;">
                                        </div>
                                    </td>
                                    ...
                                    <td class="td-actions text-right">
                                        <a class="btn text-danger text-gradient px-3 mb-0 action_delete" href=""
                                            data-url="{{ route('admin.tour_price.delete', ['id' => $tour->id]) }}"><i
                                                class="material-icons text-sm me-2 ">delete</i>Delete</a>
                                        <a class="btn btn-link text-dark px-3 mb-0"
                                            href="{{ route('admin.tour_price.edit', ['id' => $tour->id]) }}"><i
            ...
            <div class="col-md-12 pagination">
                {{$tourPrices->links("pagination::bootstrap-4")}}
            </div>
        </div>
    </div>
</div>
